...
call ps.cmd -Command "Get-Item %TARGET% -Force | Select-Object Name, @{n='LastWriteTime';e={$_.LastWriteTime.ToISOLike()}}, Length, Mode, @{n='Hash';e={$_.GetFileHash().GetCaptionWithBase64()}} | Format-Table -Wrap"
